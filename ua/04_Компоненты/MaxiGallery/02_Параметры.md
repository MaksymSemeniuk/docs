	...
	<div class="panel panel-default">
		...
		<div id="collapse657" class="panel-collapse collapse">
			<div class="panel-body">
				<span class="text-bold">Формат:</span> top | topleft | topright | left | center | right | bottom | bottomleft | bottomright | resize<br>
				<span class="text-bold">Значення за замовчуванням:</span> resize<br>
				<span class="text-bold">Примітка:</span> Опция resize - подгоняет размер imagemask к размеру изображения.<br>
				<span class="text-bold">Приклад:</span>
	...
	<div class="panel panel-default">
		...
		<div id="collapse673" class="panel-collapse collapse">
			<div class="panel-body">
				<span class="text-bold">Формат:</span> 0 | 1<br>
				<span class="text-bold">Значення за замовчуванням:</span> 0<br>
				<span class="text-bold">Примітка:</span> Это необходимо в определенных серверных средах.<br>
				<span class="text-bold">Приклад:</span>
