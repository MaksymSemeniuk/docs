...
Параметры glossaryFilter сніпета Ditto.	
<br>
...
<span class="text-bold">Примітка:</span> ВАЖНО! Вам лучше избегать использования поля content, либо делать это осмотрительно<br>
