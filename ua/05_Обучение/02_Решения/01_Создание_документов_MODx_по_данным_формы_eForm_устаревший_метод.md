**Это устаревший метод. Рекомендуем для создания документов использовать сніпет FormLister, либо заменить в сніпете вызовы функций на методы библиотеки MODx Api. **

Однако, как Приклад работы со сніпетами и событиями eForm, это решение очень хорошо подходит.
