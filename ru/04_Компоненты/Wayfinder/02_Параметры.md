...
Основные параметры сніпета Wayfinder.	
<br>
...
<span class="text-bold">Примітка:</span> В этом файле находятся шаблоны и параметры для отображения меню. Файл конфигурации должен иметь Назва filename.config.php. Приклады расположены в папке: <code>/assets/snippets/wayfinder/configs/</code><br>
...
<span class="text-bold">Примітка:</span> Установить режим отладки для диагностики.<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Формат:</span> 0 | 1<br>
<span class="text-bold">Значення за замовчуванням:</span> 0<br>
<span class="text-bold">Примітка:</span> Если &amp;displayStart=1 заставит Wayfinder вывести ссылку на документ, используемый в качестве &amp;startId, используя шаблон &amp;startItemTpl. Параметр работает, если только &amp;startId не равен нулю.<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Примітка:</span> список любых документов, разделенный запятыми<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Значення за замовчуванням:</span> текущий id<br>
<span class="text-bold">Примітка:</span> Нужно указывать только если скрипт сам его неверно определяет, наПриклад при выводе меню из чанка другого сніпета.<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Значення за замовчуванням:</span> 0<br>
<span class="text-bold">Примітка:</span> 0 - показывать все уровни<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Значення за замовчуванням:</span> 0<br>
<span class="text-bold">Примітка:</span> 0 - без ограничения<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Значення за замовчуванням:</span> нет<br>
<span class="text-bold">Примітка:</span> Весь код результата будет сохранен в переменную, значение которой можно вставить в страницу при помощи плейсхолдера с именем переменной.<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Формат:</span> 0 | 1<br>
<span class="text-bold">Значення за замовчуванням:</span> 0<br>
<span class="text-bold">Примітка:</span> Убирать символ переноса строки при выводе. т. е. весь результирующий код будет в виде одной строки.<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Формат:</span> <br>
<span class="text-bold">Значення за замовчуванням:</span> нет<br>
<span class="text-bold">Примітка:</span> Добавлять префикс к идентификатору (id) для каждого элемента (id складывается из значения rowIdPrefix + docId)<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Примітка:</span> ASC - по возрастанию | DESC - по убыванию<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Примітка:</span> Любой номер (ID) документа-контейнера.<br>
<span class="text-bold">Приклад:</span>
...
<span class="text-bold">Формат:</span> <br>
<span class="text-bold">Значення за замовчуванням:</span> нет<br>
<span class="text-bold">Примітка:</span> Соответствует where в MySQL<br>
<span class="text-bold">Приклад:</span>
